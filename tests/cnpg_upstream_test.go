...
func runUpstreamE2ETests(t *testing.T, cnpgRepoDir, kubeconfigPath, postgresImage string) TestResults {
	...
	excludeFilters := []string{"!backup-restore", "!snapshot", "!postgres-major-upgrade", "!plugin", "!observability", "!postgres-configuration", "!pod-scheduling", "!cluster-metadata", "!self-healing"}
